...
if __name__ == '__main__':
  ...
  while True:
    ...
    u = math.cos(math.pi / 180 * yaw) * math.cos(math.pi / 180 * pitch)
    v = math.sin(math.pi / 180 * yaw) * math.cos(math.pi / 180 * pitch)
    w = math.sin(math.pi / 180 * pitch)

    tilt = math.atan2(math.sqrt(Accel[0]**2 + Accel[1]**2), Accel[2]) * 180/math.pi
    # print(yaw, pitch)
    # print(f'u= {u}, v= {v}, w= {w}')
    # print(f'tilt angle = {tilt} deg\n')
    # print("\r\n /-------------------------------------------------------------/ \r\n")

    # print('\r\n Roll = %.2f , Pitch = %.2f , Yaw = %.2f\r\n'%(roll,pitch,yaw))
    print('\r\nAcceleration:  X = %f.2 , Y = %f.2 , Z = %f.2\r\n'%(Accel[0]/16384*9.8,Accel[1]/16384,Accel[2]/16384))
    print('\r\nTILT: %d'%(tilt))
